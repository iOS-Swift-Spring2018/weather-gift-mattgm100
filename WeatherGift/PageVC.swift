...
class PageVC: UIPageViewController {
    ...
    var currentPage = 0
    var locationsArray = ["Local City", "Sydney", "Boston", "London"  ]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ToListVC" {
            let destination = segue.destination as! ListVC    //we need to access some variables in ListVC
    ...
    func createDetailVC(forPage page: Int) -> DetailVC {
        ...
        //Coding Safety Check: forces it between 0 and count - 1
